...
const AdminCoupons = () => {
        ...
        const renderTableRows = () => {
                if (loading) {
                        return (
                                <tr>
                                        <td colSpan={6} className='px-4 py-6 text-center text-[#0B163A]'>
                ...
                if (coupons.length === 0) {
                        return (
                                <tr>
                                        <td colSpan={6} className='px-4 py-6 text-center text-[#0B163A]/80'>
                                ...
                                <td className='px-4 py-3 text-right'>
                                        <div className='flex items-center justify-end gap-2'>
                                                ...
                                                <button
                                                        ...
                                                        className='inline-flex items-center gap-1 rounded-md bg-white/10 px-3 py-1 text-sm text-[#0B163A] transition hover:bg-white/20 disabled:opacity-60'
                                                        disabled={mutationLoading}
                                                >
                                                        {coupon.isActive ? (
                                                                <>
        ...
        return (
                <div className='rounded-xl bg-white/10 p-6 text-[#0B163A] shadow-lg backdrop-blur'>
                        <div className='mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
                                <div>
                                        <h2 className='text-2xl font-semibold text-[#0B163A]'>
                                                {t("admin.coupons.title")}
                                        </h2>
                                        <p className='text-sm text-[#0B163A]/80'>{t("admin.coupons.subtitle")}</p>
                                </div>
                                <div className='flex flex-col gap-3 sm:flex-row sm:items-center'>
                                        <div className='flex items-center rounded-lg bg-white/10 px-3 py-2 shadow-inner'>
                                                ...
                                                <input
                                                        ...
                                                        className='w-48 bg-transparent text-sm text-[#0B163A] placeholder-[#0B163A]/60 focus:outline-none'
                                                />
                                        </div>
                                        <div className='flex items-center gap-2 rounded-lg bg-white/10 px-3 py-2 shadow-inner'>
                                                <select
                                                        ...
                                                        className='bg-transparent text-sm text-[#0B163A] focus:outline-none'
                                                >
                                        ...
                                        <button
                                                ...
                                                className='flex items-center justify-center gap-2 rounded-lg bg-payzone-gold px-4 py-2 font-semibold text-[#0B163A] shadow transition hover:bg-yellow-400'
                                        >
                        ...
                        <div className='overflow-x-auto rounded-lg bg-white/5 shadow-inner'>
                                <table className='min-w-full divide-y divide-white/10 text-left text-sm text-[#0B163A]'>
                                        <thead className='bg-white/10 text-xs uppercase tracking-wider text-[#0B163A]'>
                                                <tr>
                        ...
                        <div className='mt-4 flex flex-col items-center justify-between gap-3 text-sm text-[#0B163A]/90 sm:flex-row'>
                                <div>
                                ...
                                <div className='flex items-center gap-2'>
                                        <button
                                                ...
                                                className='rounded-md bg-white/10 px-3 py-1 text-[#0B163A] transition hover:bg-white/20 disabled:opacity-60'
                                        >
                                                {t("admin.coupons.pagination.prev")}
                                        </button>
                                        <span className='rounded-md bg-white/10 px-3 py-1 text-[#0B163A]'>
                        ...
                        {isFormOpen && (
                                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4'>
                                        <div className='w-full max-w-md rounded-2xl bg-payzone-navy p-6 text-[#0B163A] shadow-2xl'>
                                                <div className='mb-4 flex items-start justify-between'>
                                                        <div>
                                                                <h3 className='text-xl font-semibold text-[#0B163A]'>
                                                                        {editingCoupon
                                                                                ? t("admin.coupons.form.editTitle", { code: editingCoupon.code })
                                                                                : t("admin.coupons.form.createTitle")}
                                                                </h3>
                                                                <p className='text-sm text-[#0B163A]/80'>
                                                                        {editingCoupon
                                                        ...
                                                        <button
                                                                type='button'
                                                                onClick={closeForm}
                                                                className='rounded-full bg-white/10 p-2 text-[#0B163A] transition hover:bg-white/20'
                                                                disabled={mutationLoading}
                                                ...
                                                <form onSubmit={handleSubmit} className='space-y-4'>
                                                        <div>
                                                                <div className='mb-1 flex items-center justify-between gap-3'>
                                                                        <label className='block text-sm font-medium text-[#0B163A]'>
                                                                                {isBulkMode
                                                                        ...
                                                                        <button
                                                                                ...
                                                                                className='rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-[#0B163A] transition hover:bg-white/20 disabled:opacity-60'
                                                                ...
                                                                {isBulkMode ? (
                                                                        <>
                                                                                <textarea
                                                                                        ...
                                                                                        className='w-full rounded-lg border border-white/20 bg-white/10 px-3 py-2 text-[#0B163A] placeholder-[#0B163A]/60 focus:border-payzone-gold focus:outline-none'
                                                                                />
                                                                                <p className='mt-1 text-xs text-[#0B163A]/70'>
                                                        ...
                                                        <div>
                                                                <label className='mb-1 block text-sm font-medium text-[#0B163A]'>
                                                                ...
                                                                <input
                                                                        ...
                                                                        className='w-full rounded-lg border border-white/20 bg-white/10 px-3 py-2 text-[#0B163A] focus:border-payzone-gold focus:outline-none'
                                                                        required
                                                                />
                                                        ...
                                                        <div className='flex items-center justify-between'>
                                                                <span className='text-sm text-[#0B163A]'>
                                                        ...
                                                        <div className='flex justify-end gap-2 pt-2'>
                                                                <button
                                                                        type='button'
                                                                        onClick={closeForm}
                                                                        className='rounded-lg bg-white/10 px-4 py-2 text-sm font-semibold text-[#0B163A] transition hover:bg-white/20 disabled:opacity-60'
                                                                        disabled={mutationLoading}
                                                                >
