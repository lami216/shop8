                ...
                <div className='group relative h-96 w-full overflow-hidden rounded-xl shadow-lg ring-1 ring-white/10'>
                        <Link to={`/category/${category.slug}`} className='block h-full w-full'>
                                <div className='relative h-full w-full cursor-pointer'>
                                        <div className='absolute inset-0 z-10 bg-gradient-to-b from-transparent via-[#0B163A]/60 to-[#0B163A]/90 transition-opacity duration-500 group-hover:opacity-90' />
                                        <img
