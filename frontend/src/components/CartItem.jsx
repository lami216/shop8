...
const CartItem = ({ item }) => {
        ...
        return (
                <article
                        className='grid grid-cols-[88px_minmax(0,1fr)] items-center gap-4 rounded-2xl border border-white/12 bg-white/5 p-4 text-payzone-white shadow-lg shadow-black/20 backdrop-blur-md transition duration-300 hover:border-payzone-gold/70 sm:grid-cols-[96px_minmax(0,1fr)] sm:p-5'
                        dir='rtl'
                >
                        <Link
                        ...
                        >
                                {item.image ? (
                                        ...
                                        <div className='flex h-full w-full items-center justify-center text-payzone-white/70'>
                        ...
                        <div className='flex flex-col gap-3'>
                                <div className='flex items-start justify-between gap-3'>
                                        <h3 className='text-[clamp(1.05rem,2.4vw,1.25rem)] font-semibold text-payzone-white'>{item.name}</h3>
                                        {isDiscounted && (
                                ...
                                <div className='flex flex-wrap items-center gap-2 text-sm text-payzone-white/70'>
                                        <span>{t("cart.item.unitPrice")}</span>
                                        <div className='flex items-center gap-2 text-lg font-semibold text-payzone-gold'>
                                                {isDiscounted && (
                                                        <span className='text-xs font-medium text-payzone-white/70 line-through'>
                                ...
                                <div className='flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/10 bg-payzone-navy/70 px-3 py-2 text-sm text-payzone-white/80'>
                                        <div className='flex items-center gap-2'>
                                                ...
                                                <button
                                                        ...
                                                        className='inline-flex h-8 w-8 items-center justify-center rounded-full border border-payzone-white/30 bg-white/10 text-payzone-white transition hover:border-payzone-gold/80 hover:bg-white/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-payzone-gold'
                                                ...
                                                <span
                                                        ...
                                                        className='flex h-8 min-w-[2.5rem] items-center justify-center rounded-lg bg-white/10 text-sm font-semibold text-payzone-white'
                                                >
